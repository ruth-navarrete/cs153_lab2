...
n = 10;
  printf(1, "Lab 3: Recursing %d levels\n", n);
    1009:	c7 44 24 08 0a 00 00 	movl   $0xa,0x8(%esp)
    1010:	00 
    1011:	c7 44 24 04 a1 17 00 	movl   $0x17a1,0x4(%esp)
    1018:	00 
    1019:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1020:	e8 db 03 00 00       	call   1400 <printf>
  m = recurse(n);
    1025:	c7 04 24 0a 00 00 00 	movl   $0xa,(%esp)
    102c:	e8 1f 00 00 00       	call   1050 <recurse>
  printf(1, "Lab 3: Yielded a value of %d\n", m);
    1031:	c7 44 24 04 bd 17 00 	movl   $0x17bd,0x4(%esp)
    1038:	00 
    1039:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1040:	89 44 24 08          	mov    %eax,0x8(%esp)
    1044:	e8 b7 03 00 00       	call   1400 <printf>
  exit();
    1049:	e8 54 02 00 00       	call   12a2 <exit>
...
00001050 <recurse>:
{
  ...
  if(n == 0)
    ...
    105a:	75 07                	jne    1063 <recurse+0x13>
    return 0;
    105c:	b8 00 00 00 00       	mov    $0x0,%eax
    1061:	eb 13                	jmp    1076 <recurse+0x26>
  return n + recurse(n - 1);
    1063:	8b 45 08             	mov    0x8(%ebp),%eax
    1066:	83 e8 01             	sub    $0x1,%eax
    1069:	89 04 24             	mov    %eax,(%esp)
    106c:	e8 df ff ff ff       	call   1050 <recurse>
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    ...
    1399:	0f b6 92 e2 17 00 00 	movzbl 0x17e2(%edx),%edx
  }while((x /= base) != 0);
    ...
    140e:	8d 45 10             	lea    0x10(%ebp),%eax
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    152f:	8b 38                	mov    (%eax),%edi
          s = "(null)";
    1531:	b8 db 17 00 00       	mov    $0x17db,%eax
